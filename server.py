...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def deal_post_data(self):
        ...
        for uploaded_file in uploaded_files:
            if uploaded_file.endswith('.blend'):
                os.system("blender "+ uploaded_file +" -o //"+ uploaded_file.split("\\")[-1].split(".")[0] +" -F PNG -f 24 -E CYCLES -b") # blender chambre.blend -o //output -F PNG -f 24 -E CYCLES -b
